...
<body> 
      <%
			...
			"</div>");%>
            	<a href="http://61.245.226.108:8181/damoimServer/viewAllList.jsp?userId=<%=userId%>&sort=hotclick">전체보기</a></br></br>
            <%
            out.println("인기정책_평점");
            out.println("<div class=\"container\">" + 
			...
			"</div>");
            %>
            <a href="http://61.245.226.108:8181/damoimServer/viewAllList.jsp?userId=<%=userId%>&sort=hotrating">전체보기</a>
